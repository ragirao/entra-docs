...
- In IEEE 802.11 networks the policy "Allow to create all user profiles" must be using the default "enable", if modified to "disable" it drops the Wi-Fi connection when "Reset password" is pressed.
